...
describe('Heading component', () => {
  it('should render correctly with typography "heading01"', () => {
    const { container } = render(<Heading typography="heading01">Hello World!</Heading>);
  ...
  it('should render correctly with typography "heading02"', () => {
    const { container } = render(<Heading typography="heading02">Hello World!</Heading>);
    const headingElement = container.firstChild as HTMLElement;
    expect(headingElement).toBeInTheDocument();
    expect(headingElement.tagName).toBe('H1');
  ...
  it('should render correctly with typography "heading03"', () => {
    const { container } = render(<Heading typography="heading03">Hello World!</Heading>);
    const headingElement = container.firstChild as HTMLElement;
    expect(headingElement).toBeInTheDocument();
    expect(headingElement.tagName).toBe('H1');
  ...
  it('should render correctly with typography "heading04"', () => {
    const { container } = render(<Heading typography="heading04">Hello World!</Heading>);
    const headingElement = container.firstChild as HTMLElement;
    expect(headingElement).toBeInTheDocument();
    expect(headingElement.tagName).toBe('H1');
  ...
  it('should render correctly with typography "heading05"', () => {
    const { container } = render(<Heading typography="heading05">Hello World!</Heading>);
    const headingElement = container.firstChild as HTMLElement;
    expect(headingElement).toBeInTheDocument();
    expect(headingElement.tagName).toBe('H1');
  ...
  it('should render correctly with typography "heading06"', () => {
    const { container } = render(<Heading typography="heading06">Hello World!</Heading>);
    const headingElement = container.firstChild as HTMLElement;
    expect(headingElement).toBeInTheDocument();
    expect(headingElement.tagName).toBe('H1');
  ...
  it('should render correctly with typography "heading07"', () => {
    const { container } = render(<Heading typography="heading07">Hello World!</Heading>);
    const headingElement = container.firstChild as HTMLElement;
    expect(headingElement).toBeInTheDocument();
    expect(headingElement.tagName).toBe('H1');
  ...
  it('should render correctly with typography "heading08"', () => {
    const { container } = render(<Heading typography="heading08">Hello World!</Heading>);
    const headingElement = container.firstChild as HTMLElement;
    expect(headingElement).toBeInTheDocument();
    expect(headingElement.tagName).toBe('H1');
  ...
  it('should render correctly with typography "heading09"', () => {
    const { container } = render(<Heading typography="heading09">Hello World!</Heading>);
    const headingElement = container.firstChild as HTMLElement;
    expect(headingElement).toBeInTheDocument();
    expect(headingElement.tagName).toBe('H1');
  ...
  it('should render correctly with typography "heading10"', () => {
    const { container } = render(<Heading typography="heading10">Hello World!</Heading>);
    const headingElement = container.firstChild as HTMLElement;
    expect(headingElement).toBeInTheDocument();
    expect(headingElement.tagName).toBe('H1');
